...
const char* scriptUrl = "https://script.google.com/macros/s/AKfycbwY3-LAvKbmJKhNnmy5UdpWUdHIiouRGoUMQ4gTsaZLzE2pA-JehwpW3VPNAuvfNpYp/exec";
...
void loop() {
  ...
  Serial.print(" NH3 Gas Level on ESP-1: ");
